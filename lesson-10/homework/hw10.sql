--create database lesson_10_hw_10
--use lesson_10_hw_10
...
--- Using the Employees and Departments tables, write a query to return the names and 
...
FROM 
    Employees e
LEFT JOIN 
    Employees m ON e.ManagerID = m.ManagerID;
