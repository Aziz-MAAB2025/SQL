--create database lesson_11_hw_11
--use lesson_11_hw_11
...
WHERE 
    ...
    OR (
        LENGTH(e.name) 
        - LENGTH(REPLACE(LOWER(e.name), 'a', ''))
        + LENGTH(e.name) 
        - LENGTH(REPLACE(LOWER(e.name), 'e', ''))
        + LENGTH(e.name) 
        - LENGTH(REPLACE(LOWER(e.name), 'i', ''))
        + LENGTH(e.name) 
        - LENGTH(REPLACE(LOWER(e.name), 'o', ''))
        + LENGTH(e.name) 
        - LENGTH(REPLACE(LOWER(e.name), 'u', ''))
    ) >= 4;
