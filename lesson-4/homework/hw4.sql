...
SELECT *
FROM Orders
WHERE OrderDate BETWEEN CURRENT_DATE - INTERVAL '180 days' AND CURRENT_DATE

SELECT *
FROM Orders
WHERE OrderDate BETWEEN DATE_SUB(CURDATE(), INTERVAL 180 DAY) AND CURDATE()
