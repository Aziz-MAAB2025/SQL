...
--- 10. Using Orders and Invoices tables, list customer IDs who placed orders in 2023 January to find 
--- those who did not have invoices.
select * from Orders
...
SELECT 
    ...
    AVG(TotalAmount) AS AvgOrderTotalAmount
FROM 
    Orders
GROUP BY 
    YEAR(OrderDate)
