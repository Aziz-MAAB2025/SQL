...
FROM 
    Payments
INNER JOIN 
    Orders ON Payments.StudentID = Orders.StudentID;
...
--- 25. Using Orders, Payments, Customers table List customers who have made an order, 
